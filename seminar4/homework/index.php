...
$works = [
    [
        'name' => 'по сей день',
        'period' => 'декабрь 2022 - по настоящее время',
        'info' => 'ggggr',
    ],
    [
        'name' => 'вторая',
        'period' => 'декабрь 2017 - ноябрь 2022',
         'info' => 'ghjimo',
    ],
    [
        'name' => 'первая',
        'period' => 'сентябрь 2014 - ноябрь 2017',
         'info' => 'ghfdgfs',
    ],
];
?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $works[$i]['period'];?></h6>
            <p><?= $works[$i]['info'];?></p>
            <hr>
            <?php endfor; ?>
          </div>
